 			...
 			<div class="col-lg-12 main-chart">
 				...
 				<table class="table table-striped">
 					<form action="fungsi/edit/edit.php?barang=edit" method="POST">
 						...
 						<tr>
 							<td>Jenis</td>
 							<td><input type="text" class="form-control" value="<?php echo $hasil['jenis'];?>"
 									name="jenis"></td>
 						</tr>
 						<tr>
 							<td>Ukuran</td>
 							<td><input type="text" class="form-control" value="<?php echo $hasil['ukuran'];?>"
 									name="ukuran"></td>
 						</tr>
 						<tr>
 							<td>Harga</td>
 							<td><input type="number" class="form-control" value="<?php echo $hasil['harga'];?>"
 									name="harga"></td>
 						</tr>
 						<tr>
 							<td>Satuan Barang</td>
